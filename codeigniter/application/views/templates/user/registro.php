        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 align-item-center">
                ...
                <div class="border border">
                    <h3 class="bg-gray p-4">Registrar Usuario</h3>
                    <form method="POST" action="/codeigniter/index.php/usuarios/salvarregistro">
                        <fieldset class="p-4">
                            <input name="nome" id="nome" type="text" placeholder="nome*" class="border p-3 w-100 my-2">
                            <input name="email" id="email" type="email" placeholder="Email*" class="border p-3 w-100 my-2">
